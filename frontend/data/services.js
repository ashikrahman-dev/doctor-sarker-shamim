...
export async function appointmentFormService(formData) {
    const url = new URL("/api/appointment-datas", getStrapiURL());
    ...
    try {
        ...
        console.error("Appointment form service error:", error);
        throw error;
    }
}
