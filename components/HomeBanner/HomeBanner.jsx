...
export default function HomeBanner() {
    return (
        <section className="bg-dark-8 pt-[226px] relative before:absolute before:content-[''] before:left-0 before:top-0 before:w-[980px] before:h-full before:bg-[linear-gradient(270deg,rgba(247,231,208,0)_22.87%,#FFE4C2_62.4%)] after:absolute after:content-[''] after:right-0 after:top-0 after:w-[980px] after:h-full after:bg-[linear-gradient(90deg,rgba(247,231,208,0)_22.87%,#FFE4C2_62.4%)]">
            <div className="container z-10 relative">
                <div className="text-center">
                    ...
                    <h1 className="text-7xl text-light-foreground leading-[1.3] font-normal font-anton">
                ...
                <div className="grid grid-cols-12 gap-6 items-end">
                    ...
                    <div className="col-span-4 mb-28">
                        ...
                        <div className="flex gap-6">
                            <div className="w-full rounded-2xl bg-white/35 text-center p-4">
                                <h3 className="text-5xl text-light-foreground font-anton leading-[1.4]">
                                    50,000
                                </h3>
                                <p className="text-light-foreground text-base leading-[1.5]">
                                    Patient Served
                                </p>
                            </div>
                            <div className="w-full rounded-2xl bg-white/35 text-center p-4">
                        ...
                        <p className="text-2xl text-light-foreground leading-[1.3] my-7.5">
                    ...
                    <div className="col-span-4">
                        <div className="-ms-20 -me-20">
                            <Image src="/images/dr-shamim.png" alt="Dr Shamim" width={623} height={807} className="" />
                        </div>
                    </div>
                    <div className="col-span-4">
                        <div className="w-full rounded-2xl bg-white/35 py-9 px-6 backdrop-blur-[7px] mb-28">
                            <h3 className="text-2xl text-light-foreground leading-[1.32] font-anton">
